...
- [[SenML|RFC 8428 SenML]]
- [[SSI|SSI - Simple Sensor Interface]]
- [[MQTT]]
- [[Sparkplug B]]
- [[CoAP]]
- [[LwM2M]]
- [[OPC UA/OPC UA Telemetry|OPC UA Telemetry]]
- [[DDS]]
- [[W3C WoT|W3C Web of Things]]
- [[Matter]]
- [[BACnet]]
- [[KNX]]
- [[Modbus]]
...
|---|---|---|---|---|---|---|---|---|
|[[SenML\|RFC 8428 SenML]]|Payload only|Via transport|Via transport|—|partial|yes|depends|weak|
|[[SSI]]|yes|limited|limited|limited|yes|yes|low|weak|
|[[MQTT]]|limited*|yes|yes|no|topic hierarchy|yes|medium|weak|
|[[Sparkplug B\|MQTT + Sparkplug B]]|limited*|yes|yes|partial|structured topics|yes|medium|medium|
...
|[[OPC UA/OPC UA Telemetry\|OPC UA]]|yes|yes|yes|yes|node graph|yes|high|very strong|
...
|[[OPC UA/OPC UA Telemetry\|OPC UA]]|yes|yes|native methods|very strong|good|very strong|
...
| Industrial interoperability | [[OPC UA/OPC UA Telemetry\|OPC UA]]      |
...
|Semantic industrial|[[OPC UA/OPC UA Telemetry\|OPC UA]]|typed object graph|

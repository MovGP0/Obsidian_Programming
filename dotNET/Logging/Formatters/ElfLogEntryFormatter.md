---
title: Extended Log Format (ELF) Formatter
---
Outputs Extended Log Format (ELF) with header lines. This formatter expects HTTP-style fields in `LogEvent.Properties`.
...
public sealed class ElfLogEntryFormatter : ILogEntryFormatter, ILogFileHeaderProvider
{
